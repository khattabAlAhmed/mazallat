...
const ContactSection = () => {
    ...
    const contactInfo = [
        { icon: FaPhone, label: t('info.phone'), value: '+966 50 000 0000', href: 'tel:+966500000000', color: 'bg-cyan-500/10 text-cyan-500' },
        { icon: FaWhatsapp, label: t('info.whatsapp'), value: '+966 50 000 0000', href: 'https://wa.me/966500000000', color: 'bg-green-500/10 text-green-500' },
